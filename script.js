...
if (window.matchMedia("(max-width: 999px)").matches) {
    alert("You are on a mobile device. The burger maker is not optimized for mobile use. In the maker, no mobile support is in mind. Please use a desktop browser for the best experience.");
